  ...
  return (
    <LoginStage>
      <div className="mb-8 flex justify-center">
        <div className="relative grid size-20 place-items-center rounded-[30px] border border-cyan-300/28 bg-cyan-300/10 shadow-[0_0_110px_-16px_rgba(125,211,252,0.95)]">
          ...
          <CandlestickChart className="size-8 text-cyan-100" />
        </div>
      </div>
      ...
      >
        <div className="group relative">
          ...
          <input
            autoComplete="off"
            className={`${inputClass} h-14 border-white/12 bg-black/40 text-base shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]`}
            id="login-username"
            name="username"
