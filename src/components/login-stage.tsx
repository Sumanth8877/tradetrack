...
export function LoginStage({ children }: LoginStageProps) {
  ...
  return (
    ...
    >
      ...
      <div className="login-energy-field pointer-events-none absolute left-1/2 top-1/2 size-[58rem] -translate-x-1/2 -translate-y-1/2" />
      <div className="login-energy-beam login-energy-beam-left pointer-events-none absolute left-[22%] top-1/2 h-[44rem] w-32 -translate-y-1/2" />
      <div className="login-energy-beam login-energy-beam-right pointer-events-none absolute right-[18%] top-1/2 h-[40rem] w-28 -translate-y-1/2" />
      ...
      <div className="login-signal-arc login-signal-arc-a pointer-events-none absolute left-1/2 top-1/2 size-[58rem] -translate-x-1/2 -translate-y-1/2" />
      <div className="login-signal-arc login-signal-arc-b pointer-events-none absolute left-1/2 top-1/2 size-[43rem] -translate-x-1/2 -translate-y-1/2" />
      <div className="login-signal-arc login-signal-arc-c pointer-events-none absolute left-1/2 top-1/2 size-[30rem] -translate-x-1/2 -translate-y-1/2" />
